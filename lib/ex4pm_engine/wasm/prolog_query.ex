defmodule Ex4pmEngine.Wasm.PrologQuery do
  @moduledoc """
  wasm4pm-ex4pm-bindings `prolog_query` adapter -- hand-written, not
  generated. Thin wrapper over an already-implemented, plain
  (non-wasm_bindgen) pub fn already present in the `prolog8`
  crate. See `~/wasm4pm/crates/prolog8` for the real Rust
