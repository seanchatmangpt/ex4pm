defmodule Ex4pmEngine.Wasm.Forecast do
  @moduledoc """
  ...
  Injected transport key: `:forecast_wasm_fun`.
  """

  use Ex4pmEngine.Wasm.Adapter,
    algorithm_id: :forecast,
    engine_id: :wasm_forecast,
    wasm_export: "wasm4pm_ex4pm_forecast_v1",
    wasm_replay_export: "wasm4pm_ex4pm_forecast_replay_v1"
end
