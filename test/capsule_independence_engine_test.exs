defmodule Ex4pmCore.CapsuleIndependenceEngineTest do
  ...
  test "current capsule needs independent evidence and moved context invalidates the predecessor attempt" do
    ...
    assert {:ok, %{replay: true}} =
             CurrentEngine.qualify(attempt, [context], currentness_witness, 15)
    ...
    assert {:error, {:refused, :stale_target}} =
             CurrentEngine.qualify(attempt, [moved], moved_witness, 15)
  end
end
