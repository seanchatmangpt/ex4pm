...
def main() -> int:
    ...
    checks = {
        ...
        "consumer_repo": subject.get("consumer_repo") == "seanchatmangpt/ex4pm",
        "consumer_base": subject.get("consumer_base") == EXPECTED_CONSUMER,
        "producer_base": subject.get("producer_base") == EXPECTED_PRODUCER,
        "target": subject.get("producer_target_token") == "esf:ex4pmTarget",
