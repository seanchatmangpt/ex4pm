defmodule Ex4pmCore.ProcessIR.Extractor.Evidence.Admission do
  ...
  def admit(%{standing: :unsupported, name: name}), do: {:error, {:unsupported, :extractor_unavailable, name}}
  def admit(%{name: name, standing: standing}), do: {:error, {:refused, :extractor_not_admitted, {name, standing}}}
