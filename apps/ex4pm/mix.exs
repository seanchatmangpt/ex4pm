defmodule Ex4pmPublic.MixProject do
  ...
  defp deps do
    [
      {:ex4pm_contracts, "~> 26.9.9", in_umbrella: true},
      {:ex4pm_core, "~> 26.9.9", in_umbrella: true},
      {:ex4pm_evidence, "~> 26.9.9", in_umbrella: true},
      {:ex4pm_engine, "~> 26.9.9", in_umbrella: true},
      {:ex4pm_runtime, "~> 26.9.9", in_umbrella: true},
      {:ex4pm_stream, "~> 26.9.9", in_umbrella: true},
      {:ex4pm_domain, "~> 26.9.9", in_umbrella: true}
    ]
  end
